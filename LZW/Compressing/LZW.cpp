...
void LZW::inicializar_diccionario()
{
...
void LZW::comprimir(std::vector<std::string> &content, const std::string &output_file)
{
...
std::vector<std::string> LZW::descomprimir(const std::string &input_file)
{
...
void LZW::escribir_codigo(int code, std::ofstream &fout)
{
